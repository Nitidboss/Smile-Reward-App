...
class RewardService {
  /// ดึงรายการรางวัลทั้งหมดที่มีในระบบ
  /// คืนค่าเป็น List ของ Reward objects พร้อมข้อมูลรางวัลที่หลากหลาย
  /// ในระบบจริงอาจจะดึงข้อมูลจาก API หรือฐานข้อมูล
  static List<Reward> getAllRewards() {
    return [
      Reward(
        id: '1',
        name: 'Adidas Ultraboost Core Black',
        description: 'รองเท้าวิ่งยอดนิยม สวมใส่สบายสำหรับการออกกำลังกาย',
        points: 300,
      ...
      Reward(
        ...
        description: 'ดีไซน์ล้ำสมัย พร้อมเทคโนโลยีรองรับแรงกระแทก',
        points: 280,
      ...
      Reward(
        ...
        description: 'หูฟังไร้สายตัดเสียงรบกวน พร้อมเคสชาร์จ',
        points: 4500,
      ...
      Reward(
        ...
        description: 'สมาร์ทแบนด์วัดการนอน ออกกำลังกาย และวัดชีพจร',
        points: 12350,
      ...
      Reward(
        ...
        description: 'ลำโพงอัจฉริยะพร้อม Alexa ผู้ช่วยส่วนตัวสั่งงานด้วยเสียง',
        points: 10000,
